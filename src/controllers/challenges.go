...
/*
  Challenge может быть бесконечным, но пока БОО мы будем это игнорировать и следовательно у нас все challenge конечные
  отжатся 1000 раз за месяц и у каждого юзер партисипатион свой старт и конец
*/
